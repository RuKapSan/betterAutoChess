#Модуль , который изначально переводил расположение шахмат в fen
#В данной версии используется для красивого отображения fen в консоли, а логика вынесена в упрощённые функции класса Immortall
#!/bin/python
# coding=utf8
